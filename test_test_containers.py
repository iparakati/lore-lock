...
import sys
import os
from test_containers_game import World, AIClient
...
class TestGame(unittest.TestCase):
    def test_story(self):
        from test_containers_game import GAME_DATA
        # Monkey patch
        import test_containers_game
        test_containers_game.AIClient = MockAIClient
